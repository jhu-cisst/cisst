...
class osaThreadSignalTest: public CppUnit::TestFixture
{
    ...
    {
        CPPUNIT_TEST(TestThreadSignalInternalsSize);
        CPPUNIT_TEST(TestThreadSignalWaitBlocks);
    }
...
public:
    ...
    void TestThreadSignalInternalsSize(void);

    /*! Check that waits do block */
    void TestThreadSignalWaitBlocks(void);
};
