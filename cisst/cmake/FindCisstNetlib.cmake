  ...
  if (CISSTNETLIB_DOWNLOAD_NOW)
    ...
    if (WIN32)
      if (CISST_CMAKE_COMPILER_IS_MSVC_64)
        message (SEND_ERROR "Sorry, cisstNetlib download is not available for 64 bits Windows")
...
if (CISSTNETLIB_DIR)
  ...
  if (CMAKE_CL_64)
    find_library (CISSTNETLIB_LIBRARY lapack "${CISSTNETLIB_DIR}/lib" "${CISSTNETLIB_DIR}")
    find_library (CISSTNETLIB_F2C_LIBRARY libf2c "${CISSTNETLIB_DIR}/lib" "${CISSTNETLIB_DIR}")
    find_library (CISSTNETLIB_BLAS_LIBRARY blas "${CISSTNETLIB_DIR}/lib" "${CISSTNETLIB_DIR}")
    set (CISSTNETLIB_LIBRARIES ${CISSTNETLIB_LIBRARY} ${CISSTNETLIB_F2C_LIBRARY} ${CISSTNETLIB_BLAS_LIBRARY})
    mark_as_advanced (CISSTNETLIB_F2C_LIBRARY CISSTNETLIB_BLAS_LIBRARY)
  else (CMAKE_CL_64)
