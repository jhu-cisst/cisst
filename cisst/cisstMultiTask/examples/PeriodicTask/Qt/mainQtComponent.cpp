...
/*
  $Id: main.cpp 3417 2012-01-31 21:54:21Z adeguet1 $
...
mainQtComponent::mainQtComponent(const std::string &name) : mtsComponent(name)
{
    ...
    tab1Layout= new QGridLayout(tab1Widget);
...
void mainQtComponent::AddWidgetTab1(QWidget *widget, int num)
{
    tab1Layout->addWidget(widget, 1, num);
}
