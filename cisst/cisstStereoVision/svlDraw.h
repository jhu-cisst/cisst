...
namespace svlDraw
{
    ...
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, int cx, int cy, int rx, int ry, unsigned char r, unsigned char g, unsigned char b, double from_angle = 0.0, double to_angle = 360.0, double rotation = 0.0, int thickness = 1);
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, int cx, int cy, int rx, int ry, svlRGB color, double from_angle = 0.0, double to_angle = 360.0, double rotation = 0.0, int thickness = 1);
