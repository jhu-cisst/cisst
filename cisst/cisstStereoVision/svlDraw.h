...
namespace svlDraw
{
    ...
    // RGB
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, int cx, int cy, int rx, int ry, unsigned char r, unsigned char g, unsigned char b, double angle = 0.0, double from_angle = 0.0, double to_angle = cmnPI_x2, int thickness = 1);
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, int cx, int cy, int rx, int ry, svlRGB color, double angle = 0.0, double from_angle = 0.0, double to_angle = cmnPI_x2, int thickness = 1);
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, const svlEllipse & ellipse, svlRGB color, double from_angle = 0.0, double to_angle = cmnPI_x2, int thickness = 1);
    void CISST_EXPORT Ellipse(svlSampleImage* image, unsigned int videoch, const svlEllipse & ellipse, unsigned char r, unsigned char g, unsigned char b, double from_angle = 0.0, double to_angle = cmnPI_x2, int thickness = 1);
