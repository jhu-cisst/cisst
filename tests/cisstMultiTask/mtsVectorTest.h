...
/*
  $Id: mtsVectorTest.h 456 2009-06-13 03:11:44Z adeguet1 $
...
class mtsVectorTest: public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(mtsVectorTest);
...
CPPUNIT_TEST_SUITE_REGISTRATION(mtsVectorTest);
