...
vctFrame4x4<double> FKinePUMA560( size_t i, double t ){
  ...
  double DH[6][3] = { {  0.0000,  cmnPI_2, 0.66183 },   // link 1
		      {  0.4318,      0.0, 0.0000 },   // link 2
		      {  0.0203, -cmnPI_2, -0.1197 },   // link 3
		      {  0.0000,  cmnPI_2, 0.4318 },   // link 4
		      {  0.0000, -cmnPI_2, 0.0000 },   // link 5
		      {  0.0000,      0.0, 0.0000 } }; // link 6
