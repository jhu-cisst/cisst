...
/*
  $Id: vctFixedSizeMatrixTest.h,v 1.14 2007/09/24 18:40:53 anton Exp $
...
class vctFixedSizeMatrixTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(vctFixedSizeMatrixTest);
