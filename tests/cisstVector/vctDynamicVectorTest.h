...
/*
  $Id: vctDynamicVectorTest.h,v 1.21 2008/12/16 20:51:55 ofri Exp $
...
class vctDynamicVectorTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(vctDynamicVectorTest);
    ...
    CPPUNIT_TEST(TestConversionFromFixedSizeDouble);
    CPPUNIT_TEST(TestConverstionFromFixedSizeFloat);
    CPPUNIT_TEST(TestConversionFromFixedSizeInt);
 ...
 public:
    ...
    template<class _elementType>
    void TestConversionFromFixedSize(void);
    void TestConversionFromFixedSizeDouble(void);
    void TestConverstionFromFixedSizeFloat(void);
    void TestConversionFromFixedSizeInt(void);
