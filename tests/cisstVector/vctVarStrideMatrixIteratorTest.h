...
/*
  $Id: vctVarStrideMatrixIteratorTest.h,v 1.6 2007/04/26 20:12:05 anton Exp $
...
#ifndef _vctVarStrideMatrixIteratorTest_h
#define _vctVarStrideMatrixIteratorTest_h
...
*/
class vctVarStrideMatrixIteratorTest: public CppUnit::TestCase
{
    CPPUNIT_TEST_SUITE(vctVarStrideMatrixIteratorTest);
 ...
 public:
    ...
    typedef vctDynamicMatrix<MatrixElementType> MatrixType;
    typedef MatrixType::Submatrix::Type Submatrix1Type;
 ...
 public:
    vctVarStrideMatrixIteratorTest():
        MyMatrix(ROWS, COLS),
        RandomGenerator(cmnRandomSequence::GetInstance()),
        Submatrix1(MyMatrix, /* from */ 1, 1, /* size */ ROWS1, COLS1)
    {}
...
#endif  // _vctVarStrideMatrixIteratorTest_h
