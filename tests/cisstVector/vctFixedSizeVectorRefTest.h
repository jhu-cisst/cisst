...
/*
  $Id: vctFixedSizeVectorRefTest.h,v 1.9 2007/04/26 20:12:05 anton Exp $
...
class vctFixedSizeVectorRefTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(vctFixedSizeVectorRefTest);
