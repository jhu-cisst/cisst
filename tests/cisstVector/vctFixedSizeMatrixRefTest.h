...
/*
  $Id: vctFixedSizeMatrixRefTest.h,v 1.6 2007/04/26 20:12:05 anton Exp $
...
class vctFixedSizeMatrixRefTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(vctFixedSizeMatrixRefTest);
