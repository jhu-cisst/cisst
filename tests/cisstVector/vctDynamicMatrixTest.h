...
/*
  $Id: vctDynamicMatrixTest.h,v 1.18 2008/12/16 00:13:54 ofri Exp $
...
class vctDynamicMatrixTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(vctDynamicMatrixTest);
    ...
    CPPUNIT_TEST(TestSizingMethodsDouble);
    CPPUNIT_TEST(TestSizingMethodsFloat);
    CPPUNIT_TEST(TestSizingMethodsInt);

    CPPUNIT_TEST(TestAccessMethodsDouble);
    CPPUNIT_TEST(TestAccessMethodsFloat);
    CPPUNIT_TEST(TestAccessMethodsInt);

    CPPUNIT_TEST(TestExchangeAndPermutationDouble);
    CPPUNIT_TEST(TestExchangeAndPermutationFloat);
    CPPUNIT_TEST(TestExchangeAndPermutationInt);
 ...
 public:
    ...
    /*! Test sizing methods */
    template <class _elementType>
    void TestSizingMethods(bool storageOrder);
    void TestSizingMethodsDouble(void);
    void TestSizingMethodsFloat(void);
    void TestSizingMethodsInt(void);
    ...
    /*! Test exchange and permutations of rows and columns */
    template<class _elementType>
        void TestExchangeAndPermutation(void);
    void TestExchangeAndPermutationDouble(void);
    void TestExchangeAndPermutationFloat(void);
    void TestExchangeAndPermutationInt(void);
