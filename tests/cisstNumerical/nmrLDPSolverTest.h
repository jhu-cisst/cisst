...
/*
  $Id: nmrLDPSolverTest.h,v 1.6 2007/04/26 20:12:05 anton Exp $
...
#ifndef _nmrLDPSolverTest_h
#define _nmrLDPSolverTest_h
...
class nmrLDPSolverTest : public CppUnit::TestCase
{
    CPPUNIT_TEST_SUITE(nmrLDPSolverTest);
