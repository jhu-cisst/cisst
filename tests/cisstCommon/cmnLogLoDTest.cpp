...
void cmnLogLoDTest::TestMasks(void)
{
    ...
    CPPUNIT_ASSERT((CMN_LOG_ALLOW_ERROR & CMN_LOG_LEVEL_INIT_ERROR));
    CPPUNIT_ASSERT((CMN_LOG_ALLOW_ERROR & CMN_LOG_LEVEL_RUN_ERROR));
    CPPUNIT_ASSERT(!(CMN_LOG_ALLOW_ERROR & CMN_LOG_LEVEL_INIT_WARNING));
    CPPUNIT_ASSERT(!(CMN_LOG_ALLOW_ERROR & CMN_LOG_LEVEL_RUN_WARNING));

    CPPUNIT_ASSERT((CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_INIT_ERROR));
    CPPUNIT_ASSERT((CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_RUN_ERROR));
    CPPUNIT_ASSERT((CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_INIT_WARNING));
    CPPUNIT_ASSERT((CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_RUN_WARNING));
    CPPUNIT_ASSERT(!(CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_INIT_VERBOSE));
    CPPUNIT_ASSERT(!(CMN_LOG_ALLOW_WARNING & CMN_LOG_LEVEL_RUN_VERBOSE));
