...
The SAW package currently contains the following **active** components:
...
.. list-table::
   ...
   * - Component
     - Description
   * - `saw3Dconnexion <https://github.com/jhu-saw/saw3Dconnexion>`__
   ...
   * - `sawHaplyService <https://github.com/jhu-saw/sawHaplyService>`__
     - Interface to Haply haptic devices
...
The following components are **no longer actively maintained**:
