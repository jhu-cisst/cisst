...
Once, we get the data, then a Matlab script `QuinticRn.m </jhu-cisst/cisst/tree/master/cisstRobot/examples/QuinticRn.m>`__ takes the two log file and plot them.
