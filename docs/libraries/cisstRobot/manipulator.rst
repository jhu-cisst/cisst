...
`Kinematics Parameters <https://github.com/jhu-cisst/cisst/blob/main/cisstRobot/robKinematics.h>`__
---------------------------------------------------------------------------------------------------
...
`Dynamics Parameters <https://github.com/jhu-cisst/cisst/blob/main/cisstRobot/robMass.h>`__
-------------------------------------------------------------------------------------------
...
Robot components are a set of "blocks" that implement specific tasks in a robot system. Available components are: manipulators (e.g., `Barrett WAM <https://github.com/jhu-saw/sawBarrett>`__), `controllers <https://github.com/jhu-saw/sawControllers>`__ and `trajectories <https://github.com/jhu-saw/sawTrajectories>`__. There are also two simulators available. The first one is based on `OpenSceneGraph <https://github.com/jhu-saw/sawOpenSceneGraph>`__ and can only simulate the kinematics of a robot. The second one is based on `Open Dynamics Engine <https://github.com/jhu-saw/sawOpenDynamicsEngine>`__ (and OpenSceneGraph) and can simulate kinematics and dynamics. Note that both robot simulators are derived from robManipulator and thus they use the same configuration file.
...
Example: `Barrett WAM <https://github.com/jhu-saw/sawBarrett>`__
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
