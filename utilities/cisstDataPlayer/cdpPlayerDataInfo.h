...
#ifndef _cdpPlayerDataInfo_h
#define _cdpPlayerDataInfo_h
...
public:
    typedef cdpPlayerDataInfo ThisType;

    /*! default constructor - does nothing for now */
    cdpPlayerDataInfo();

       /*! Copy constructor. */
    inline cdpPlayerDataInfo(const ThisType & other):
...
CMN_DECLARE_SERVICES_INSTANTIATION(cdpPlayerDataInfo);

#endif // _cdpPlayerDataInfo_h
