...
*/
size_t nmrConstraintOptimizer::GetNumVars() const
{
	return NumVars;
}
...
/*! Reset
*/
void nmrConstraintOptimizer::ResetIndices()
{
	CIndex = 0;
	AIndex = 0;
	EIndex = 0;
...
/*! allocate
*/
void nmrConstraintOptimizer::Allocate()
{
...
*/
size_t nmrConstraintOptimizer::GetObjectiveRows() const
{
	return C.rows();
}
...
*/
size_t nmrConstraintOptimizer::GetIneqConstraintRows() const
{
	return A.rows();
}
...
*/
size_t nmrConstraintOptimizer::GetEqConstraintRows() const
{
	return E.rows();
}
...
*/
size_t nmrConstraintOptimizer::GetObjectiveIndex() const
{
	return CIndex;
}
...
*/
size_t nmrConstraintOptimizer::GetIneqConstraintIndex() const
{
	return AIndex;
}
...
*/
size_t nmrConstraintOptimizer::GetEqConstraintIndex() const
{
	return EIndex;
}

size_t nmrConstraintOptimizer::GetSlackIndex() const
{
    return SlackIndex;
}
...
*/
size_t nmrConstraintOptimizer::GetSlacks() const
{
	return Slacks;
}
...
*/
const vctDoubleMat & nmrConstraintOptimizer::GetObjectiveMatrix() const
{
	return C;
}
...
*/
const vctDoubleVec & nmrConstraintOptimizer::GetObjectiveVector() const
{
	return d;
}
...
*/
const vctDoubleMat & nmrConstraintOptimizer::GetIneqConstraintMatrix() const
{
	return A;
}
...
*/
const vctDoubleVec & nmrConstraintOptimizer::GetIneqConstraintVector() const
{
	return b;
}
...
*/
const vctDoubleMat & nmrConstraintOptimizer::GetEqConstraintMatrix() const
{
	return E;
}
...
*/
const vctDoubleVec & nmrConstraintOptimizer::GetEqConstraintVector() const
{
	return f;
}
