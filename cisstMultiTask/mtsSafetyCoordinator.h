...
public:
    ...
    */
    ...
    //  Events
    //-------------------------------------------------- 
    // Called by casros (SF::Coordinator) when event is detected and generated by filter.
    // This can be used as a hook for events from casros, which can be used to perform
