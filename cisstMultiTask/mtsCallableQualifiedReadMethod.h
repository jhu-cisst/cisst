...
#ifndef _mtsCallableQualifiedReadMethod_h
#define _mtsCallableQualifiedReadMethod_h
...
class mtsCallableQualifiedReadMethod: public mtsCallableQualifiedReadBase {
...
private:
    ...
    inline mtsCallableQualifiedReadMethod(const ThisType & CMN_UNUSED(other)) {}
...
public:
    ...
    mtsCallableQualifiedReadMethod(void): BaseType(), ClassInstantiation(0) {}
