...
/*
  ...
  (C) Copyright 2001-2011 Johns Hopkins University (JHU), All Rights
  Reserved.
...
/*! \file
    \brief Macros to export the symbols of cisstCommonXML (in a Dll).
*/

// check if this module is build as a DLL
#ifdef cisstCommonXML_EXPORTS
