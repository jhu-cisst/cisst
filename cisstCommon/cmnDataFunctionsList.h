...
#pragma once
#ifndef _cmnDataFunctionsList_h
#define _cmnDataFunctionsList_h
...
class cmnData<std::list<_elementType> >
{
public:
    enum {IS_SPECIALIZED = 1};

    typedef std::list<_elementType> DataType;
    ...
    {
        return cmnDataVectorScalarNumber(data) + 1; /* treat list size as a scalar */
    }
