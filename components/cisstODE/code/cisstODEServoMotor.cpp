...
cisstODEServoMotor::cisstODEServoMotor(dWorldID world, 
				       dBodyID body1, 
				       dBodyID body2,
...
dJointID cisstODEServoMotor::MotorID() const { return motorid; }

void cisstODEServoMotor::SetPosition( double qs, double q, double dt ){
...
void cisstODEServoMotor::SetVelocity( double qd ){
