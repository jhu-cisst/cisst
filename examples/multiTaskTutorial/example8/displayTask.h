...
protected:
    ...
    mtsDouble Data;
    mtsDouble DataFromQualifiedRead;
    mtsDouble DataFromEventWrite;
    mtsDouble AmplitudeData;
    mtsDouble AmplitudeDataForQualifiedRead;

    struct {
        // functions which will be bound to commands
        mtsFunctionRead GetData;
        mtsFunctionWrite SetAmplitude;
        mtsFunctionQualifiedRead SetAndGetAmplitude;
        mtsFunctionVoid ButtonByCommandVoid;
    } Generator;

    // event handlers
    void HandleEventWrite(const mtsDouble & value);
