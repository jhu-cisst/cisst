    ...
    mtsTaskPeriodic(taskName, period, false, 5000)
{
    ...
    mtsInterfaceProvided * robot1Interface = AddInterfaceProvided("Robot1");
    mtsInterfaceProvided * robot1ObserverInterface = AddInterfaceProvided("Robot1Observer");
    mtsInterfaceProvided * robot2Interface = AddInterfaceProvided("Robot2");
    mtsInterfaceProvided * robot2ObserverInterface = AddInterfaceProvided("Robot2Observer");
