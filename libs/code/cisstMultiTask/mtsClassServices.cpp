...
#if 0
mtsHistory.cpp:CMN_IMPLEMENT_SERVICES_TEMPLATED(mtsDoubleHistory);
mtsHistory.cpp:CMN_IMPLEMENT_SERVICES_TEMPLATED(mtsDoubleVecHistory);
mtsManagerGlobal.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerGlobal);
mtsManagerGlobal.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerGlobalInterface);
mtsManagerLocal.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerLocal);
mtsManagerLocal.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerLocalInterface);

mtsComponentInterfaceProxyClient.cpp:CMN_IMPLEMENT_SERVICES(mtsComponentInterfaceProxyClient);
mtsComponentInterfaceProxyServer.cpp:CMN_IMPLEMENT_SERVICES(mtsComponentInterfaceProxyServer);
mtsComponentProxy.cpp:CMN_IMPLEMENT_SERVICES(mtsComponentProxy);
mtsManagerProxyClient.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerProxyClient);
mtsManagerProxyServer.cpp:CMN_IMPLEMENT_SERVICES(mtsManagerProxyServer);
