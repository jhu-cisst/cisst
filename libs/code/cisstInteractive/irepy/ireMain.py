...
#  $Id: ireMain.py,v 1.32 2007/04/26 19:33:57 anton Exp $
#
...
# $Log: ireMain.py,v $
# Revision 1.32  2007/04/26 19:33:57  anton
# All files in libraries: Applied new license text, separate copyright and
# updated dates, added standard header where missing.
#
# Revision 1.31  2006/12/03 07:11:44  pkaz
# cisstInteractive: ignore Python future warnings (it is a nuissance).
#
# Revision 1.30  2006/12/01 03:12:30  pkaz
# cisstInteractive: last fix for Mac broke Linux -- this fixes it.
#
# Revision 1.29  2006/12/01 02:06:36  pkaz
# cisstInteractive: fixed off-by-one error in scrolling of command history list.
#
# Revision 1.28  2006/11/30 18:33:51  anton
# cisstInteractive: Fix for bug on mac while loading history.
#
# Revision 1.27  2006/11/20 20:33:19  anton
...
#
# Revision 1.26  2006/09/19 04:20:20  pkaz
# cisstInteractive: changed logging to be thread-safe (use wxPostEvent to post message to GUI thread
# rather than calling wxLogMessage). Also, added SetActiveFlag callback so that Python code
# could set flag after IRE is initialized and app loop is entered.
#
