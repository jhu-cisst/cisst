...
/*
  $Id: svlVideoFileWriter.cpp 545 2009-07-14 08:38:33Z adeguet1 $
...
int svlFilterVideoFileWriter::Initialize(svlSample* inputdata)
{
    ...
    SaveThread.Create<svlFilterVideoFileWriter, unsigned int>(this, &svlFilterVideoFileWriter::SaveProc, img->GetVideoChannels());
    SaveInitEvent.Wait();
...
int svlFilterVideoFileWriter::OnStart(unsigned int procCount)
{
...
int svlFilterVideoFileWriter::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
...
void* svlFilterVideoFileWriter::SaveProc(unsigned int videochannels)
{
