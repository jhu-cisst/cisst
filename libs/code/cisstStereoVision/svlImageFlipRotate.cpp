...
/*
  $Id: svlImageFlipRotate.cpp,v 1.6 2008/10/22 20:04:13 vagvoba Exp $
...
#include <cisstStereoVision/svlImageFlipRotate.h>
#include <cisstImage/imgUCharRGB.h>

using namespace std;

/*************************************/
/*** svlImageFlipRotate class ********/
/*************************************/

svlImageFlipRotate::svlImageFlipRotate() :
    svlFilterBase()
{
...
int svlImageFlipRotate::Initialize(svlSample* inputdata)
{
    Release();
...
int svlImageFlipRotate::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
    ///////////////////////////////////////////
...
int svlImageFlipRotate::Release()
{
    if (OutputData) {
        delete OutputData;
        OutputData = 0;
...
int svlImageFlipRotate::SetHorizontalFlip(bool flip)
{
...
int svlImageFlipRotate::SetHorizontalFlip(unsigned int videoch, bool flip)
{
    if (IsInitialized()) return SVL_FAIL;
...
int svlImageFlipRotate::SetVerticalFlip(bool flip)
{
    if (IsInitialized()) return SVL_FAIL;
...
int svlImageFlipRotate::SetVerticalFlip(unsigned int videoch, bool flip)
{
    if (IsInitialized()) return SVL_FAIL;
...
int svlImageFlipRotate::SetRotation(int cw_quarters)
{
    if (IsInitialized()) return SVL_FAIL;
...
int svlImageFlipRotate::SetRotation(unsigned int videoch, int cw_quarters)
{
    if (IsInitialized()) return SVL_FAIL;
