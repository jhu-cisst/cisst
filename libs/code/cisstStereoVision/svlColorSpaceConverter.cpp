...
/*
  $Id: svlColorSpaceConverter.cpp,v 1.4 2008/10/22 14:51:58 vagvoba Exp $
...
#include <cisstStereoVision/svlColorSpaceConverter.h>
#include "svlConverters.h"

using namespace std;

/*************************************/
/*** svlColorSpaceConverter class ****/
/*************************************/

svlColorSpaceConverter::svlColorSpaceConverter() : svlFilterBase()
{
...
svlColorSpaceConverter::~svlColorSpaceConverter()
{
    Release();
}

int svlColorSpaceConverter::Initialize(svlSample* inputdata)
{
    Release();
...
int svlColorSpaceConverter::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
    ///////////////////////////////////////////
...
int svlColorSpaceConverter::Release()
{
    return SVL_OK;
}

void svlColorSpaceConverter::SetConversion(svlColorSpace input, svlColorSpace output)
{
    InputColorSpace = input;
    OutputColorSpace = output;
}

void svlColorSpaceConverter::SetChannelMask(bool ch1, bool ch2, bool ch3)
{
    Channel1 = ch1;
    Channel2 = ch2;
    Channel3 = ch3;
...
void svlColorSpaceConverter::ConvertColorSpace(unsigned char* buffer, unsigned int numofpixels)
{
