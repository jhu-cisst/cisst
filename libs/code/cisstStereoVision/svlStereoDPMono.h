...
/*
  $Id: svlStereoDPMono.h,v 1.5 2008/10/22 14:51:58 vagvoba Exp $
...
class svlStereoDPMono : public svlStereoMethodBase
{
public:
    svlStereoDPMono(int width, int height, int left, int top, int right, int bottom,
