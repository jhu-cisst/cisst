...
/*
  $Id: svlStreamTypeConverter.cpp,v 1.11 2008/10/22 20:04:13 vagvoba Exp $
...
#include <cisstStereoVision/svlStreamTypeConverter.h>
#include "svlConverters.h"

using namespace std;

/******************************************/
/*** svlStreamTypeConverter class *********/
/******************************************/
...
//
svlStreamTypeConverter::svlStreamTypeConverter(svlStreamType inputtype, svlStreamType outputtype) : svlFilterBase()
{
...
svlStreamTypeConverter::~svlStreamTypeConverter()
{
    Release();
...
int svlStreamTypeConverter::Initialize(svlSample* inputdata)
{
    Release();
...
int svlStreamTypeConverter::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
    ///////////////////////////////////////////
...
int svlStreamTypeConverter::Release()
{
    return SVL_OK;
}
