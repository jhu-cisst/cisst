...
/*
  $Id: svlImageResizer.cpp,v 1.17 2008/11/14 22:05:06 vagvoba Exp $
...
#include <cisstStereoVision/svlImageResizer.h>
...
/******************************************/
/*** svlImageResizer class ****************/
/******************************************/

svlImageResizer::svlImageResizer() : svlFilterBase()
{
...
svlImageResizer::~svlImageResizer()
{
    Release();
}

int svlImageResizer::SetOutputSize(unsigned int width, unsigned int height, unsigned int videoch)
{
...
int svlImageResizer::SetOutputRatio(double widthratio, double heightratio, unsigned int videoch)
{
...
int svlImageResizer::Initialize(svlSample* inputdata)
{
    Release();
...
int svlImageResizer::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
    ///////////////////////////////////////////
...
int svlImageResizer::ResampleMono8(unsigned char* src, const unsigned int srcwidth, const unsigned int srcheight,
...
int svlImageResizer::ResampleAndInterpolateHMono8(unsigned char* src, const unsigned int srcwidth,
...
int svlImageResizer::ResampleAndInterpolateVMono8(unsigned char* src, const unsigned int srcheight,
...
int svlImageResizer::ResampleRGB24(unsigned char* src, const unsigned int srcwidth, const unsigned int srcheight,
                                   unsigned char* dst, const unsigned int dstwidth, const unsigned int dstheight)
{
    unsigned int i, j;
    unsigned int x1, y1, x2, y2;
...
int svlImageResizer::ResampleAndInterpolateHRGB24(unsigned char* src, const unsigned int srcwidth,
                                                  unsigned char* dst, const unsigned int dstwidth,
                                                  const unsigned int height)
{
    unsigned int i, j;
...
int svlImageResizer::ResampleAndInterpolateVRGB24(unsigned char* src, const unsigned int srcheight,
                                                  unsigned char* dst, const unsigned int dstheight,
                                                  const unsigned int width)
{
    unsigned int i, j;
