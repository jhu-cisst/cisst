...
/*
  $Id: svlImageSampler.cpp,v 1.14 2008/10/22 20:04:13 vagvoba Exp $
...
#include <cisstStereoVision/svlImageSampler.h>
#include "svlConverters.h"

using namespace std;

/******************************************/
/*** svlImageSampler class ****************/
/******************************************/

svlImageSampler::svlImageSampler() : svlFilterBase()
{
...
svlImageSampler::~svlImageSampler()
{
    Release();
}

void svlImageSampler::SetCallback(svlImageSamplerCallbackBase* callbackobj)
{
    CallbackObj = callbackobj;
}

int svlImageSampler::Initialize(svlSample* inputdata)
{
...
int svlImageSampler::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
