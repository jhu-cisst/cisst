...
/*
  $Id: svlUnsharpMask.cpp 545 2009-07-14 08:38:33Z adeguet1 $
...
#include <cisstStereoVision/svlFilterUnsharpMask.h>
#include <string.h>
...
int svlFilterUnsharpMask::Initialize(svlSample* inputdata)
{
    Release();
...
int svlFilterUnsharpMask::Release()
{
    if (OutputData) {
        delete OutputData;
        OutputData = 0;
...
int svlFilterUnsharpMask::SetAmount(int amount)
{
...
int svlFilterUnsharpMask::SetRadius(int radius)
{
...
int svlFilterUnsharpMask::SetThreshold(int threshold)
{
...
void svlFilterUnsharpMask::FilterBlur(unsigned char* img_in, unsigned char* img_out, const int width, const int height, int radius)
{
...
void svlFilterUnsharpMask::Sharpening(unsigned char* img_in, unsigned char* img_mask, unsigned char* img_out, const int width, const int height)
{
