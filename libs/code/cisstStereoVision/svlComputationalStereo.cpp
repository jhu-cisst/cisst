...
/*
  $Id: svlComputationalStereo.cpp,v 1.18 2008/10/22 20:04:13 vagvoba Exp $
...
/******************************************/
/*** svlComputationalStereo class *********/
/******************************************/

svlComputationalStereo::svlComputationalStereo() : svlFilterBase()
{
    ...
    XCheckEnabled = false;
    StereoMethod = svlStereoMethodDP;
...
svlComputationalStereo::~svlComputationalStereo()
{
    Release();
...
int svlComputationalStereo::Initialize(svlSample* inputdata)
{
    ...
    if (inputtype != svlTypeImageRGBStereo && StereoMethod != svlStereoMethodDP) return SVL_FAIL;
...
int svlComputationalStereo::ProcessFrame(ProcInfo* procInfo, svlSample* inputdata)
{
    ///////////////////////////////////////////
...
int svlComputationalStereo::Release()
{
    if (StereoAlgorithm) {
...
int svlComputationalStereo::SetCrossCheck(bool enabled)
{
...
bool svlComputationalStereo::GetCrossCheck()
{
    return XCheckEnabled;
}

void svlComputationalStereo::SetMethod(svlStereoMethod method)
{
    StereoMethod = method;
}

svlStereoMethod svlComputationalStereo::GetMethod()
{
    return StereoMethod;
}

int svlComputationalStereo::SetFocalLength(double focallength)
{
...
double svlComputationalStereo::GetFocalLength()
{
    return static_cast<double>(FocalLength);
}

int svlComputationalStereo::SetStereoBaseline(double baseline)
{
...
double svlComputationalStereo::GetStereoBaseline()
{
    return static_cast<double>(Baseline);
}

void svlComputationalStereo::SetPrincipalPoints(double ppx_left, double ppx_right, double ppy)
{
...
void svlComputationalStereo::GetPrincipalPoints(double &ppx_left, double &ppx_right, double &ppy)
{
...
void svlComputationalStereo::SetDisparityRange(unsigned int mindisparity, unsigned int maxdisparity)
{
    MinDisparity = mindisparity;
    MaxDisparity = maxdisparity;
}

void svlComputationalStereo::GetDisparityRange(unsigned int& mindisparity, unsigned int& maxdisparity)
{
    mindisparity = MinDisparity;
    maxdisparity = MaxDisparity;
}

void svlComputationalStereo::SetBlockSize(unsigned int blocksize)
{
    BlockSize = blocksize;
}

unsigned int svlComputationalStereo::GetBlockSize()
{
    return BlockSize;
}

void svlComputationalStereo::SetScalingFactor(unsigned int scalefactor)
{
    ScaleFactor = scalefactor;
}

unsigned int svlComputationalStereo::GetScalingFactor()
{
    return ScaleFactor;
}

void svlComputationalStereo::SetQuickSearchRadius(unsigned int searchradius)
{
    NarrowedSearchRadius = searchradius;
}

unsigned int svlComputationalStereo::GetQuickSearchRadius()
{
    return NarrowedSearchRadius;
}

void svlComputationalStereo::SetSmoothnessFactor(unsigned int smoothness)
{
    Smoothness = smoothness;
}

unsigned int svlComputationalStereo::GetSmoothnessFactor()
{
    return Smoothness;
}

void svlComputationalStereo::SetTemporalFiltering(double tempfilt)
{
    TemporalFilter = tempfilt;
}

double svlComputationalStereo::GetTemporalFiltering()
{
    return TemporalFilter;
}

void svlComputationalStereo::SetSpatialFiltering(unsigned int radius)
{
    SpatialFilterRadius = radius;
}

unsigned int svlComputationalStereo::GetSpatialFiltering()
{
    return SpatialFilterRadius;
}

void svlComputationalStereo::SetValidRect(int left, int top, int right, int bottom)
{
    ValidAreaLeft = left;
    ValidAreaTop = top;
...
void svlComputationalStereo::CreateXCheckImageColor(unsigned char* source, unsigned char* target, const unsigned int width, const unsigned int height)
{
    unsigned int i, j;
...
void svlComputationalStereo::PerformXCheck()
{
...
void svlComputationalStereo::ConvertDisparityToDistance(int* disparitymap, float* depthmap, const int mapwidth, const int mapheight)
{
    int i, j, disp;
...
void svlComputationalStereo::ApplySpatialFilter(const int radius,
