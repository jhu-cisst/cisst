...
/*
  $Id: trkCisstBase.h,v 1.2 2007/09/24 16:05:50 vagvoba Exp $
...
// Virtual base tracker class
#ifndef _BASE_TRACKER_CISST_H
#define _BASE_TRACKER_CISST_H
