...
public:
  ...
  // Anton, pure virtual needed to compile
  void Finalize(void) { std::cerr << "Finalize" << std::endl;}
  void CreateAWindow(void) { std::cerr << "CreateAWindow" << std::endl;}
  void DestroyWindow(void) { std::cerr << "DestroyWindow" << std::endl;}
