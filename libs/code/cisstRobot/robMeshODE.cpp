...
robMeshODE::robMeshODE() : robMeshTriangular(){
  vertices = NULL;
  indices = NULL;
}

// Deallocate the arrays
robMeshODE::~robMeshODE(){
...
robMeshODE::robMeshODE( const robMeshODE& mesh ) : robMeshTriangular( mesh ){
...
// assignment operator
robMeshODE& robMeshODE::operator=(const robMeshODE& mesh){
...
robError robMeshODE::Load( const std::string& filename ){
...
void robMeshODE::Configure( dSpaceID space ){
  this->space = space; 
