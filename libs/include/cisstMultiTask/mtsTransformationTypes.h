...
MTS_PROXY_CLASS_DECLARATION_FROM(vctFrmDouble4x4, mtsFrmDouble4x4);
MTS_PROXY_CLASS_DECLARATION_FROM(vctFrmFloat4x4, mtsFrmFloat4x4);

MTS_PROXY_CLASS_DECLARATION_FROM(vctDoubleAnRot2, mtsDoubleAnRot2);
MTS_PROXY_CLASS_DECLARATION_FROM(vctFloatAnRot3, mtsFloatAnRot3);
