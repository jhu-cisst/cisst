...
#ifndef _devODEGripper_h
#define _devODEGripper_h
...
//! ODE gripper
/**
   This class implements a gripper device for ODE simulation. The class
   ...
   The hand creates 2 fingers, themselves ODE manipulators devices and 
   dispatches the I/O to each finger.
*/
class CISST_EXPORT devODEGripper : public devODEManipulator {
 ...
 public:
  ...
  devODEGripper( const std::string& devname,
		 double period,
		 ...
		 const std::string& f1model,
		 const std::string& f2model );
