...
namespace cisstRobot{
  ...
  */
  ...
  public:
    ...
    robDOF();
    //! Create a DOF with the given mask
    robDOF( uint64_t dof );
    virtual ~robDOF();          // meh! just to make it polymorphic
    ...
    //! Return how many DOF the mask contains.
   ...
   //! Used by the map
    ...
    //! DOF of all Cartesian orientation (R) and translations (T)
    ...
    //! DOF of all Cartesian angular (W) and linear (V) velocities
   ...
   static const uint64_t WZ  = 0x0000000000002000ULL;
    ...
    //! DOF of all real velocities (joint velocities)
    static const uint64_t XVEL= 0x0000FF0000000000ULL;
    //! DOF of the 1st joint velocity
    static const uint64_t XD1 = 0x0000010000000000ULL;
    //! DOF of the 2nd joint velocity
    static const uint64_t XD2 = 0x0000020000000000ULL;
    //! DOF of the 3rd joint velocity
    static const uint64_t XD3 = 0x0000040000000000ULL;
    //! DOF of the 4th joint velocity
    static const uint64_t XD4 = 0x0000080000000000ULL;
    //! DOF of the 5th joint velocity
    static const uint64_t XD5 = 0x0000100000000000ULL;
    //! DOF of the 6th joint velocity
    static const uint64_t XD6 = 0x0000200000000000ULL;
    //! DOF of the 7th joint velocity
    static const uint64_t XD7 = 0x0000400000000000ULL;
    //! DOF of the 8th joint velocity
    static const uint64_t XD8 = 0x0000800000000000ULL;
    
    //! DOF of all real velocities (joint accelerations)
    static const uint64_t XACC= 0x00FF000000000000ULL;
    //! DOF of the 1st joint acceleration
    static const uint64_t XDD1= 0x0001000000000000ULL;
    //! DOF of the 2nd joint acceleration
    static const uint64_t XDD2= 0x0002000000000000ULL;
    //! DOF of the 3rd joint acceleration
    static const uint64_t XDD3= 0x0004000000000000ULL;
    //! DOF of the 4th joint acceleration
    static const uint64_t XDD4= 0x0008000000000000ULL;
    //! DOF of the 5th joint acceleration
    static const uint64_t XDD5= 0x0010000000000000ULL;
    //! DOF of the 6th joint acceleration
    static const uint64_t XDD6= 0x0020000000000000ULL;
    //! DOF of the 7th joint acceleration
    static const uint64_t XDD7= 0x0040000000000000ULL;
    //! DOF of the 8th joint acceleration
    static const uint64_t XDD8= 0x0080000000000000ULL;
    
    //! DOF that represents the time
    static const uint64_t TIME= 0x0000000100000000ULL;
  ...
  //! A DOF class for forces and torques
  class robDOFForceTorque : public robDOF {
    
  public:
    
    //! The force torque value
    R6 forcetorque;
    
    //! Create an empty force torque DOF
    robDOFForceTorque();
    //! Create a force/torque DOF with the given values
    /**
       This creates a force/torque DOF object with the given
       values and sets the mask of every F/T DOF
       \param ft
     */
    robDOFForceTorque( const R6& ft );
    
  };
  
  //! A DOF class for Cartesian DOF
  class robDOFSE3 : public robDOF{
  ...
  public:
    ...
    //! Create an empty Cartesian DOF object
    robDOFSE3();
    ...
    /**
       ...
       accelerations
     */
    robDOFSE3( const SE3& Rt, const R6& vw, const R6& vdwd );
  };
  
  //! A DOF class for real DOF
  class robDOFRn: public robDOF{
  ...
  public:
    ...
    //! Create an empty real DOF object
    robDOFRn();

    //! Create a real DOF object with a single value
    /**
       Create a 1D DOF object and only sets the X1 DOF mask
     */
    robDOFRn( real x );
    ...
    */
    robDOFRn( const Rn& x, const Rn& xd, const Rn& xdd );
