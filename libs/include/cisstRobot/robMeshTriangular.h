...
public:
  ...
  */
  ...
  /**
     Perform a deep copy of the mesh. If necessary, it deallocates the memory and
     allocates new arrays and copy the content of the mesh
     \param mesh A mesh to be copied
  */
