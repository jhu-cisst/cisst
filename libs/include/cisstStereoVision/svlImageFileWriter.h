...
/*
  $Id: svlImageFileWriter.h,v 1.9 2008/10/17 17:44:38 vagvoba Exp $
...
#ifndef _svlImageFileWriter_h
#define _svlImageFileWriter_h
...
class CISST_EXPORT svlImageFileWriter : public svlFilterBase
{
public:
    svlImageFileWriter();
    virtual ~svlImageFileWriter();
