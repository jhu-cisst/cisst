...
/*
  $Id: svlImageRectifier.h,v 1.1 2008/10/17 17:44:38 vagvoba Exp $
...
#ifndef _svlImageRectifier_h
#define _svlImageRectifier_h
...
class CISST_EXPORT svlImageRectifier : public svlFilterBase
{
