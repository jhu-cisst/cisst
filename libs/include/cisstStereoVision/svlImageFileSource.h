...
/*
  $Id: svlImageFileSource.h,v 1.10 2008/10/17 17:44:38 vagvoba Exp $
...
#ifndef _svlImageFileSource_h
#define _svlImageFileSource_h
...
class CISST_EXPORT svlImageFileSource : public svlFilterBase
{
public:
    svlImageFileSource(bool stereo = false);
    virtual ~svlImageFileSource();
