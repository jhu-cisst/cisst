...
/*
  $Id: svlImageCropper.h,v 1.4 2008/10/17 17:44:38 vagvoba Exp $
...
#ifndef _svlImageCropper_h
#define _svlImageCropper_h
...
class CISST_EXPORT svlImageCropper : public svlFilterBase
{
public:
    svlImageCropper();
    virtual ~svlImageCropper();
