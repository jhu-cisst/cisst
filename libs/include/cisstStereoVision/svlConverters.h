...
namespace svlConverter
{
    ...
    void Gray16toRGBA32(unsigned short* input, unsigned char* output, unsigned int pixelcount, const unsigned int shiftdown = 0);
    ...
    void float32toRGBA32(float* input, unsigned char* output, const unsigned int pixelcount, const float scalingratio = 1.0f);
